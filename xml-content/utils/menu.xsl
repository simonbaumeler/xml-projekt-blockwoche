...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="sites" select="'index:Home,feature2:Feature2,feature3:Feature3,report:Report generieren,participants:Participants,'" /> <!-- must end in ',' due to strange bug -->
